...
export default function ProgressStages({ progress, currentStage }) {
  const stages = [
    ...
    { id: 3, label: 'Generating LinkedIn content', threshold: 40 },
    { id: 4, label: 'Generating Instagram content', threshold: 50 },
    { id: 5, label: 'Generating Twitter threads', threshold: 60 },
    { id: 6, label: 'Generating Facebook posts', threshold: 70 },
    { id: 7, label: 'Creating long-form content', threshold: 85 },
    { id: 8, label: 'Finalizing package', threshold: 100 }
  ];
